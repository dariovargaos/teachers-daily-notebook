    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <Heading as="h1" mt={4} fontSize="xl">
            Nevažeća poveznica
          </Heading>
          <Text mt={3} fontSize="sm" color="fg.muted">
            Ova poveznica nije ispravna. Zatraži novu poveznicu za resetiranje
            lozinke.
          </Text>
          <RouterLink to="/forgot-password">
            <Button mt={6} variant="outline" borderRadius="2xl" size="lg">
              <LuArrowLeft />
              Natrag
            </Button>
          </RouterLink>
      ...
      >
        ...
        {isSuccess ? (
          ...
          >
            ...
            <HStack justify="flex-start" fontSize="xs" color="fg.muted" mt={-3}>
              <Button
                type="button"
                variant="plain"
                size="xs"
